            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  {subitemSlug === 'ecoloadmaster' && (
                    <a
                      href="/brochures/ELM%20PROFILE.pdf"
                      download="Ecoloadmaster Profile.pdf"
                      className="inline-flex items-center justify-center gap-2 border border-white/40 text-white px-6 py-3 rounded-lg hover:bg-white/10 transition-colors text-base font-semibold whitespace-nowrap"
                    >
